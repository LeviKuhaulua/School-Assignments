...
{   
   ...
   **/ 
    ...
    *  <P> 
    *    <B>Length:</B> The length of the Statistician generated by the {@code add} method can result in an ARITHMETIC OVERFLOW 
    *    if the sum of the {@code s1.length} and {@code s2.length} exceeds Integer.MAX_VALUE. 
    *  </P> 
    * 
    *  <P> 
    *     <B>Sum & Mean:</B> The sum of the Statistician generated by the {@code add} method may result in POSITIVE INFINITY or NEGATIVE INFINITY if the result of 
    *    {@code s1.sum + s2.sum} is some arbitrarily large (positive or negative) number. This then means that the Mean of the Statistician will also result in either 
    *    POSITIVE INFINITY or NEGATIVE INFINITY
    *  </P> 
    * 
    * 
    *  <P> 
    *     <B>Maximum & Minimum:</B> The max and min numbers of the Statistician generated by the {@code add} method can result in POSITIVE INFINITY or NEGATIVE INFINITY if 
    *     either {@code s1} or {@code s2} has some arbitrarily large number in the sequence. This means that no matter what number you add, the maximum or minimum number will always 
    *     be POSITIVE INFINITY (in the case where we have an arbitrarily large POSITIVE number) or NEGATIVE INFINITY (in the case where we have an arbitrarily large NEGATIVE number). 
    *  </P> 
    * @throws NullPointerException if either of the Statisticians are null.  
    */
   public static Statistician add(Statistician s1, Statistician s2) {
      ...
      if (s1 == null || s2 == null) {
         throw new NullPointerException(
            "Cannot pass in a Null Statistician"
         ); 
      }

      // When s2 is empty 
      if(s1.length > 0 && s2.length == 0) {
         // Set all the statistics to the current statistics of s1
         ...
         // Set all the statistics to the current statistics of s2
         ...
         // Calculate the statistics based on s1 and s2 statistics.
         sumOfSequences.lastNum = s2.lastNum; 
